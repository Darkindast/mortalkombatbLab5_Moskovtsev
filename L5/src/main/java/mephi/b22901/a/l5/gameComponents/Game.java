...
import mephi.b22901.a.l5.actions.AtackAction;
import mephi.b22901.a.l5.actions.DebuffAction;
import mephi.b22901.a.l5.actions.DefenceAction;
import mephi.b22901.a.l5.actions.GameAction;
...
import mephi.b22901.a.l5.characters.fabrics.EnemyFabric;
import mephi.b22901.a.l5.general.JFrames;
...
public class Game {
    ...
    public Game(int numberOfLocations){
        ...
        URL iconUrl = this.getClass().getResource("/images/Millena.gif");
        this.human = new Human(1, 80, 18, ActionType.HIT, new ImageIcon(iconUrl));
...
public ArrayList<Player> enemiesInThisLocation(int level) {
    ...
    // Всегда добавляем 1 обычного врага и 1 босса
